...
export class InitialSchema1781004107648 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_f2193c20365b3efe26a39e6dab"`,
    );
